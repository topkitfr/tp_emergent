                ...
                if front_url:
                    ...
                    try:
                        ...
                        if front_url.startswith('/'):
                            ...
                            full_url = f"https://ba1f7c9d-08ba-457a-aac6-9b62a210f10b.preview.emergentagent.com{front_url}"
                        else:
                            full_url = front_url
                ...
                if back_url:
                    ...
                    try:
                        ...
                        if back_url.startswith('/'):
                            # Relative URL - construct full URL
                            full_url = f"https://ba1f7c9d-08ba-457a-aac6-9b62a210f10b.preview.emergentagent.com{back_url}"
                        else:
                            full_url = back_url
