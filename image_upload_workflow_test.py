...
# Configuration
BACKEND_URL = "https://jersey-database.preview.emergentagent.com/api"
                ...
                if front_url:
                    ...
                    try:
                        ...
                        if front_url.startswith('/'):
                            ...
                            full_url = f"https://jersey-database.preview.emergentagent.com{front_url}"
                        else:
                            full_url = front_url
                ...
                if back_url:
                    ...
                    try:
                        ...
                        if back_url.startswith('/'):
                            # Relative URL - construct full URL
                            full_url = f"https://jersey-database.preview.emergentagent.com{back_url}"
                        else:
                            full_url = back_url
