  ...
  return (
    <div className="border border-border bg-card" style={fs}>
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        <span className="text-[10px] uppercase tracking-wider text-muted-foreground">ESTIMATION</span>
        <div className="flex items-center gap-2">
          ...
          >
            {mode === 'advanced' ? <SlidersHorizontal className="w-3 h-3" /> : <Zap className="w-3 h-3" />}
            {mode === 'advanced' ? 'Advanced' : 'Basic'}
          </button>
          <span className="font-mono text-base text-accent font-semibold">{result.estimatedPrice}€</span>
      ...
      {/* Advanced form — only when editable */}
      {mode === 'advanced' && editable && (
        <div className="px-3 pt-2 pb-3 space-y-3 border-t border-border">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="space-y-1">
              ...
              <Select value={flockingOrigin || 'None'} onValueChange={v => set('flockingOrigin')(v)}>
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              <Switch id="est-patch" checked={hasPatch} onCheckedChange={v => set('hasPatch')(v)} />
              <Label htmlFor="est-patch" className={labelCls} style={fs}>Official patch</Label>
            </div>
            <div className="flex items-center gap-2">
              <Switch id="est-rare" checked={isRare} onCheckedChange={v => set('isRare')(v)} />
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Switch id="est-signed" checked={signed} onCheckedChange={v => set('signed')(v)} />
            ...
            {signed && (
              <div className="space-y-2 pl-1 border-l border-border ml-1">
                ...
                <div className="space-y-1">
                  ...
                  <Select value={signedProofLevel || 'none'} onValueChange={v => set('signedProofLevel')(v)}>
                    <SelectTrigger className={inputCls}><SelectValue /></SelectTrigger>
                    <SelectContent className="bg-card border-border">
