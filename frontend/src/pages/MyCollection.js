    ...
    try {
      ...
      if (editForm.flocking_detail && !resolvedFlockingPlayerId) {
        try {
          ...
          console.warn('createPlayerPending (flocking) failed:', e);
        }
      }
      ...
      if (editForm.signed && editForm.signed_by && !resolvedSignedByPlayerId) {
        try {
          ...
          console.warn('createPlayerPending (signed_by) failed:', e);
        }
      }
  ...
  return (
    <div className="animate-fade-in-up">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {stats && stats.total_jerseys > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6" data-testid="collection-value-stats">
              <div className="border border-border p-4 text-center">
                ...
                <div className="text-[10px] text-muted-foreground uppercase" style={fieldStyle}>
                  Total Jerseys
                </div>
              </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            {categories.length > 0 && !categoryStats.length && (
              ...
              >
                <SelectTrigger
                  className="bg-card border-border rounded-none w-48"
                  data-testid="collection-category-filter"
                >
            ...
            <div className="flex items-center border border-border ml-auto">
              <button
                ...
                data-testid="collection-view-grid"
              >
              ...
              <button
                ...
                data-testid="collection-view-list"
              >
          ...
          >
            {items.map((item) => (
              <div
                ...
                data-testid={`collection-item-${item.collection_id}`}
              >
                  ...
                  <div className="aspect-[3/4] relative overflow-hidden bg-secondary">
                    ...
                    {item.signed && (
                      <div className="absolute bottom-2 right-2">
                        <Badge className="rounded-none text-[10px] bg-accent/90 text-accent-foreground border-none">
                          Signed
                        </Badge>
                      </div>
                    )}
                ...
                <div
                  className="absolute top-2 left-2 flex gap-1 opacity-0 group-hover:opacity-100"
                ...
                >
                  <button
                    ...
                    className="p-1.5 bg-card/90 border border-border text-muted-foreground hover:text-foreground"
                    data-testid={`edit-collection-${item.collection_id}`}
                  >
                  ...
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      handleRemove(item.collection_id);
                    }}
                    className="p-1.5 bg-destructive/90 text-destructive-foreground"
                    data-testid={`remove-collection-${item.collection_id}`}
                  >
          ...
          <div className="space-y-2 stagger-children" data-testid="collection-list">
            {items.map((item) => (
              <div
                ...
                data-testid={`collection-list-item-${item.collection_id}`}
              >
                <Link
                  to={`/version/${item.version_id}`}
                ...
                {getConditionLabel(item) && (
                  <Badge variant="secondary" className="rounded-none text-[10px] shrink-0">
                    {getConditionLabel(item)}
                  </Badge>
                )}
                {item.size && (
                ...
                {item.signed && (
                  <Badge className="rounded-none text-[10px] bg-accent/90 shrink-0">Signed</Badge>
                )}
                <div
                ...
                >
                  <button
                    ...
                    data-testid={`edit-list-${item.collection_id}`}
                  >
                  ...
                  <button
                    ...
                    data-testid={`remove-list-${item.collection_id}`}
                  >
      ...
      >
        <SheetContent
          side="right"
          className="bg-background border-border w-full sm:max-w-lg overflow-y-auto"
          ...
          {detailItem && (
            <>
              ...
              <div className="mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2 mt-2">
                      <Badge variant="outline" className="rounded-none text-[10px]">
                        {detailItem.version?.model || 'None'}
                      </Badge>
                      <Badge variant="outline" className="rounded-none text-[10px]">
                        {detailItem.version?.competition || 'None'}
                      </Badge>
                    </div>
                  </div>
                </div>
                ...
                <div
                  className="grid grid-cols-2 gap-2 p-3 bg-secondary/30 border border-border mb-4"
              ...
              <div className="flex gap-2 mt-6">
                ...
                <Button
                  variant="outline"
                  onClick={() => handleRemove(detailItem.collection_id)}
