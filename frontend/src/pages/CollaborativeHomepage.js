              ...
              >
                <div className="text-center">
                  <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-2 overflow-hidden">
                    {team.logo_url ? (
                      <img 
                        src={team.logo_url.startsWith('data:') || team.logo_url.startsWith('http') ? team.logo_url : `${process.env.REACT_APP_BACKEND_URL}/${team.logo_url}`}
                        alt={team.name}
            ...
            {recentBrands.map((brand) => (
              ...
              >
                <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center mx-auto mb-4 shadow-sm overflow-hidden">
                  {brand.logo_url ? (
                    <img 
                      src={brand.logo_url.startsWith('data:') || brand.logo_url.startsWith('http') ? brand.logo_url : `${process.env.REACT_APP_BACKEND_URL}/${brand.logo_url}`}
                      alt={brand.name}
