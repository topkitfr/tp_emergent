            ...
            <div className="space-y-6">
              ...
              {contribution.images && Object.keys(contribution.images).length > 0 ? (
                  ...
                  {Object.entries(contribution.images).map(([imageType, imageData], index) => {
                    ...
                    return (
                      <div key={imageType} className="bg-gray-50 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                          <h4 className="font-medium text-gray-900">{formatFieldName(imageType)}</h4>
                          <p className="text-sm text-gray-600">Cliquez pour agrandir</p>
                        </div>
                      </div>
                    );
                  })}
                ...
                <div className="text-center py-8 text-gray-500">
                  <div className="text-4xl mb-4">📷</div>
                  <p>Aucune image proposée dans cette contribution</p>
                </div>
              )}
            </div>
          )}
