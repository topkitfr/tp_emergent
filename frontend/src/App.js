            ...
            <div className="bg-gray-900 rounded-lg border border-gray-700 p-6">
              ...
              {activeTab === 'ratings' ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Select a Tab</h3>
                  <p className="text-gray-400">Choose a tab above to view the corresponding content.</p>
                </div>
              )}
...
const UserSettingsPanel = ({ user, profileData, onProfileUpdated, onClose }) => {
        ...
        <div className="bg-gray-900 rounded-lg border border-gray-700">
          <div className="flex flex-wrap border-b border-gray-700">
            {[
              ...
              ...(isOwnProfile ? [{ id: 'settings', label: '⚙️ Paramètres' }] : [])
            ].map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
...
// Mobile-Optimized MessagingInterface Component for Friends Page
const FriendsMessagingInterface = () => {
  ...
  const [showChatView, setShowChatView] = useState(false); // Mobile navigation state
  ...
  // Select conversation (mobile-aware)
  const selectConversation = (conversation) => {
    setSelectedConversation(conversation);
  ...
  if (showChatView && selectedConversation) {
    return (
      <div className="bg-gray-800 rounded-lg border border-gray-600 h-[500px] flex flex-col">
        {/* Mobile Chat Header */}
        ...
        <div className="p-3 border-t border-gray-600">
          <div className="flex space-x-2">
            <input
              ...
              onKeyPress={handleKeyPress}
              placeholder="Tapez votre message..."
              className="flex-1 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm placeholder-gray-400 focus:outline-none focus:border-blue-500"
              disabled={sendingMessage}
            />
            <button
              onClick={sendMessage}
              disabled={!newMessage.trim() || sendingMessage}
              className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg transition-colors text-sm"
            >
              {sendingMessage ? '📤' : '▶️'}
            </button>
          </div>
  ...
  // Desktop and mobile conversations list
  return (
    <div className="bg-gray-800 rounded-lg border border-gray-600 h-[500px] flex">
      ...
      <div className={`border-r border-gray-600 flex flex-col ${showChatView ? 'hidden md:flex md:w-2/5' : 'w-full md:w-2/5'}`}>
          ...
          {conversations.length === 0 ? (
            <div className="p-6 text-center text-gray-400">
              ...
              <p className="text-xs text-gray-600">
                💡 Utilisez l'onglet "👥 Amis" pour ajouter des amis et commencer à chatter !
              </p>
            </div>
          ) : (
            <div className="divide-y divide-gray-700">
      ...
      {/* Desktop Chat Area - Hidden on mobile when showing chat */}
      <div className={`flex-1 flex-col ${showChatView ? 'hidden' : 'hidden md:flex'}`}>
                ...
                {ownedJerseys.length > 0 ? (
                  ...
                  <div className="text-center py-12 bg-gray-900 rounded-lg border border-gray-700">
                    ...
                    <p className="text-gray-500 mb-6">
                      Ajoutez des maillots que vous possédez à votre collection.
                    </p>
                    <button
                      onClick={() => window.dispatchEvent(new CustomEvent('changeView', { detail: 'jerseys' }))}
                      className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors"
              ...
              <div>
                ...
                <div className="text-center py-16 bg-gray-900 rounded-lg border border-gray-700">
                  ...
                  <p className="text-gray-500 mb-4 max-w-md mx-auto">
                    La fonctionnalité de mise en vente de vos maillots sera disponible très prochainement.
                  </p>
                  <p className="text-gray-400 text-sm">
                    Vous pourrez créer des listings pour vendre vos maillots directement depuis votre collection.
                  </p>
                  ...
                  <div className="mt-8 p-4 bg-gray-800 rounded-lg border border-gray-600 max-w-md mx-auto">
                    ...
                    <ul className="text-gray-300 text-sm space-y-1">
                      <li>• Création de listings depuis votre collection</li>
                      <li>• Gestion des prix et négociations</li>
                      <li>• Suivi des ventes et revenus</li>
                      <li>• Marketplace sécurisée avec paiements</li>
                    </ul>
                  </div>
                </div>
              </div>
...
const SearchFilter = ({ onFilter }) => {
  ...
  return (
    <div className="bg-gray-900 rounded-xl shadow-2xl p-6 mb-8 border border-gray-800">
      ...
      {/* Jersey View Modal */}
      {showJerseyViewModal && selectedJerseyForView && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 rounded-lg border border-gray-700 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-gray-900 px-6 py-4 border-b border-gray-700 flex justify-between items-center">
              <h2 className="text-xl font-bold text-white">👁️ Détails du Maillot</h2>
              <button
                onClick={() => {
                  setShowJerseyViewModal(false);
                  setSelectedJerseyForView(null);
                }}
                className="text-gray-400 hover:text-white text-2xl"
              >
                ×
            ...
            <div className="p-6">
              ...
              <div className="aspect-square bg-gray-800 rounded-lg mb-6 flex items-center justify-center overflow-hidden">
                {selectedJerseyForView.images && selectedJerseyForView.images.length > 0 ? (
                  <img
                    src={selectedJerseyForView.images[0]}
                    alt={`${selectedJerseyForView.team} ${selectedJerseyForView.season}`}
                    className="w-full h-full object-cover"
                    onError={(e) => {
                      e.target.src = 'https://dummyimage.com/400x400/333/fff.png&text=Jersey';
                    }}
                  />
                ) : (
              ...
              <div className="space-y-4">
                <div className="bg-gray-800 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="text-white ml-2 font-medium">{selectedJerseyForView.team}</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Saison:</span>
                      <span className="text-white ml-2">{selectedJerseyForView.season}</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Ligue:</span>
                      <span className="text-white ml-2">{selectedJerseyForView.league}</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Type:</span>
                      <span className="text-white ml-2">{selectedJerseyForView.home_away}</span>
                    </div>
                    {selectedJerseyForView.player && (
                      <div>
                        <span className="text-gray-400">Joueur:</span>
                        <span className="text-white ml-2 font-medium">{selectedJerseyForView.player}</span>
                      </div>
                    )}
                    <div>
                      <span className="text-gray-400">Taille:</span>
                      <span className="text-white ml-2">{selectedJerseyForView.size?.toUpperCase()}</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-gray-800 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-white mb-3">État et valeur</h3>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Condition:</span>
                      <span className={`ml-2 px-2 py-1 text-xs font-medium rounded ${
                        selectedJerseyForView.condition === 'new' ? 'bg-green-800 text-green-200' :
                        selectedJerseyForView.condition === 'near_mint' ? 'bg-blue-800 text-blue-200' :
                        selectedJerseyForView.condition === 'very_good' ? 'bg-yellow-800 text-yellow-200' :
                        selectedJerseyForView.condition === 'good' ? 'bg-orange-800 text-orange-200' :
                        'bg-red-800 text-red-200'
                      }`}>
                        {selectedJerseyForView.condition === 'new' ? 'Neuf' :
                         selectedJerseyForView.condition === 'near_mint' ? 'Quasi-neuf' :
                         selectedJerseyForView.condition === 'very_good' ? 'Très bon' :
                         selectedJerseyForView.condition === 'good' ? 'Bon' : 'Correct'}
                      </span>
                    </div>
                    <div>
                ...
                {selectedJerseyForView.jersey_type && (
                  <div className="bg-gray-800 rounded-lg p-4">
                    <h3 className="text-lg font-semibold text-white mb-3">Détails techniques</h3>
                    <div className="text-sm">
                      <span className="text-gray-400">Type de maillot:</span>
                      <span className="text-white ml-2">{selectedJerseyForView.jersey_type}</span>
                    </div>
                  </div>
                )}
                
                {selectedJerseyForView.reference_number && (
                  <div className="bg-gray-800 rounded-lg p-4">
                    <h3 className="text-lg font-semibold text-white mb-3">Référence</h3>
                    <div className="text-sm">
                      <span className="text-gray-400">Numéro de référence:</span>
                      <span className="text-white ml-2 font-mono">{selectedJerseyForView.reference_number}</span>
                    </div>
                  </div>
                )}
              </div>
  ...
  return (
      ...
      {loading ? (
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={fetchBetaRequests}
              disabled={betaRequestsLoading}
              className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-white px-4 py-2 rounded-lg transition-colors"
            >
              {betaRequestsLoading ? '🔄 Chargement...' : '🔄 Actualiser'}
            </button>
          </div>
          ...
          {betaRequestsLoading ? (
            <div className="flex items-center justify-center py-12">
              ...
              <span className="ml-3 text-white">Chargement des demandes...</span>
            </div>
            ...
            <div className="text-center py-12 bg-gray-800 rounded-xl border border-gray-700">
              ...
              <p className="text-gray-400">
                Aucune demande d'accès bêta n'a été soumise pour le moment.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                  ...
                  <div className="text-blue-300 text-sm">En Attente</div>
                </div>
                <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
                  <div className="text-green-400 text-2xl font-bold">
                    {betaRequests.filter(r => r.status === 'approved').length}
                  </div>
                  <div className="text-green-300 text-sm">Approuvées</div>
                </div>
                <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
                  <div className="text-red-400 text-2xl font-bold">
                    {betaRequests.filter(r => r.status === 'rejected').length}
                  </div>
                  <div className="text-red-300 text-sm">Rejetées</div>
                </div>
              </div>

              {/* Requests List */}
              <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
                <div className="hidden md:block bg-gray-900 px-6 py-4 border-b border-gray-700">
                ...
                <div className="divide-y divide-gray-700">
                  {betaRequests.map((request, index) => (
                    <div key={request.id} className="p-6 hover:bg-gray-750 transition-colors">
                      {/* Desktop Layout */}
                      <div className="hidden md:grid md:grid-cols-6 md:gap-4 md:items-center">
                        ...
                        <div>
                          <span className={`px-2 py-1 text-xs font-medium rounded ${
                            ...
                            request.status === 'approved' ? 'bg-green-800 text-green-200' :
                            'bg-red-800 text-red-200'
                          }`}>
                        ...
                        <div className="flex space-x-2">
                          {request.status === 'pending' && (
                            <>
                              <button
                                onClick={() => approveBetaRequest(request.id)}
                                disabled={betaRequestsLoading}
                              ...
                              <button
                                onClick={() => rejectBetaRequest(request.id)}
                                disabled={betaRequestsLoading}
                                className="bg-red-600 hover:bg-red-700 disabled:bg-gray-600 text-white text-xs px-3 py-1 rounded transition-colors"
                              >
                                ✗ Rejeter
                              </button>
                            </>
                      ...
                      <div className="md:hidden space-y-3">
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-blue-400 text-sm">{request.email}</p>
                          </div>
                          <span className={`px-2 py-1 text-xs font-medium rounded ${
                            request.status === 'pending' ? 'bg-yellow-800 text-yellow-200' :
                            request.status === 'approved' ? 'bg-green-800 text-green-200' :
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  <div className="text-blue-400 text-lg">💡</div>
                  <div>
                    <h4 className="text-blue-300 font-medium mb-1">Gestion des Demandes</h4>
                    <p className="text-blue-200 text-sm">
                      <strong>Approuver :</strong> Crée un compte utilisateur avec accès bêta ou octroie l'accès bêta à un utilisateur existant.
                      <br />
                      <strong>Rejeter :</strong> Marque la demande comme rejetée avec raison optionnelle.
                    </p>
                  </div>
                </div>
              </div>
    ...
    {showJerseyDetailEditor && selectedJerseyForDetails && (
      <JerseyDetailEditor
        ...
        onSave={() => {
          // Refresh collection data to show updated values
          setLastRefresh(Date.now());
        }}
      />
    )}
