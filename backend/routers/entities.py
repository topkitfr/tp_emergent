...
"""
Routes CRUD per-type pour teams, leagues, brands, sponsors, players.

Les routes transversales (pending listing, approve/reject, autocomplete)
ont été extraites dans entity_workflow.py en Vague 4.
Les helpers partagés (assert_not_locked, ENTITY_CONFIG) sont dans _entity_helpers.py.
"""
