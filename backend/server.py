...
async def send_password_reset_email(email: str, token: str, user_name: str = ""):
    ...
    try:
        ...
        reset_link = f"https://kit-beta.preview.emergentagent.com/reset-password?token={token}"
...
async def register(user_data: UserRegister, request: Request):
    ...
    verification_link = f"https://kit-beta.preview.emergentagent.com/verify-email?token={verification_token}"
