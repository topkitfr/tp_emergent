...
@api_router.put("/teams/{team_id}", response_model=TeamOut)
...
@api_router.post("/leagues", response_model=LeagueOut)
...
@api_router.put("/leagues/{league_id}", response_model=LeagueOut)
...
@api_router.get("/brands", response_model=List[BrandOut])
...
@api_router.post("/brands", response_model=BrandOut)
...
@api_router.put("/brands/{brand_id}", response_model=BrandOut)
...
@api_router.get("/players", response_model=List[PlayerOut])
...
@api_router.post("/players", response_model=PlayerOut)
...
@api_router.put("/players/{player_id}", response_model=PlayerOut)
