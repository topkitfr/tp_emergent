...
# Configuration
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://kit-hierarchy.preview.emergentagent.com')
...
class DeploymentTester:
    ...
    def test_environment_variables(self):
        ...
        try:
            ...
            hardcoded_patterns = [
                'https://kit-hierarchy.preview.emergentagent.com',
                'localhost:3000',
                'http://localhost'
            ]
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if 'dev_verification_link' in data:
                    ...
                    if 'FRONTEND_URL' in str(link) or link.startswith('https://kit-hierarchy.preview.emergentagent.com'):
