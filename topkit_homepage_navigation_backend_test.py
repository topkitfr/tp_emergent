    ...
    def test_image_url(self, image_url, image_name):
        ...
        try:
            ...
            if image_url.startswith('/'):
                full_url = f"https://footkit-hub.preview.emergentagent.com{image_url}"
            else:
                full_url = image_url
    ...
    def test_image_serving_endpoints(self):
        ...
        try:
            ...
            for endpoint in test_endpoints:
                try:
                    response = requests.get(f"https://footkit-hub.preview.emergentagent.com{endpoint}", timeout=5)
